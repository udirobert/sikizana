...
- **Run ID:** `phase1-kaggle-20260915T040356Z`
- **Execution:** private Kaggle CPU Kernel, self-contained runner; Python 3.12.13, pandas 2.3.3, scikit-learn 1.6.1, XGBoost 3.2.0.
...
The corresponding `meta.json`, `facts.json`, and `provenance.json` were produced by Kaggle Kernel version 5. The initial recorded source-revision field predates the final standardization correction; a final rerun will replace this preliminary remote artifact with one stamped to the exact implementation revision.
