      ...
      <section className="relative flex-1 flex flex-col justify-center px-5 py-10 sm:py-14">
        ...
        <div className="relative mx-auto w-full max-w-md">
          ...
          <p className="mt-3 text-sm text-stone-600 leading-snug fade-in-up fade-in-up-delay-1">
            ...
            . Add yours if you have them — then share the note.
          </p>
          ...
          <div className="mt-7 border-y border-stone-200 py-5 fade-in-up fade-in-up-delay-2">
            ...
            <div className="mt-3 grid grid-cols-2 gap-6">
              <div>
                <p className="text-[11px] font-semibold text-stone-500">Gross</p>
                <p className="mt-0.5 text-4xl font-bold tabular-nums tracking-tight text-stone-950 leading-none">
                  {formatPct(resolved.bench.avgGrossMargin)}
                </p>
              </div>
              <div>
                <p className="text-[11px] font-semibold text-stone-500">Net</p>
                <p className="mt-0.5 text-4xl font-bold tabular-nums tracking-tight text-stone-950 leading-none">
                  {formatPct(resolved.bench.avgNetMargin)}
                </p>
              </div>
            </div>
            ...
            <div className="mt-5 grid grid-cols-2 gap-3">
              <label className="block">
                <span className="text-[11px] font-semibold text-sky-800">Your gross %</span>
                <input
                  inputMode="decimal"
                  placeholder="—"
                  value={grossInput}
              ...
              <label className="block">
                <span className="text-[11px] font-semibold text-sky-800">Your net %</span>
                <input
                  inputMode="decimal"
                  placeholder="—"
                  value={netInput}
